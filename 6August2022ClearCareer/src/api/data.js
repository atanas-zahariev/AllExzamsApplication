...
const endpoints = {
    ...
    logout: '/users/logout',
    getAllDataInSistem: '/data/offers?sortBy=_createdOn%20desc',
    getSpecificDataWithId:'/data/offers/',
    addInSysten:'/data/offers',
...
export async function addApplication(offerId){
    const result = await post(endpoints.addApplication, {offerId});
    return result;
}

export async function getTotalAplication(offerId){
...
window.getTotalAplication = getTotalAplication;
